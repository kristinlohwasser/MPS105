...
Experiments conducted in 1968 at the Stanford Linear Accelerator Center (SLAC) and published on October 20, 1969, showed that the proton contained much smaller, point-like objects and was therefore not an elementary particle. The results and No longer matching what
was expected for elastic
collisions on nucleons
●
Scaling consistent with
sub-structure
●
The quark model idea was
confirmed
...
The elastic and inelastic peaks at 187 Mev in carbon at a scattering angle of 80$\degree$. (taken from {cite}`Halzen:1984mc`)
