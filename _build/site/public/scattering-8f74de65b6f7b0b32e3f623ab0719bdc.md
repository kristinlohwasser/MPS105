...
In the following we will see how scattering experiments are used as a tool to understand the basic constituents of matter.
...
Particle masses are expressed based on their energy as
Note: this is mc2 >> Ekin (non-relativistic case!)
Special relativity, when objects move with v ~ c
Kinetic energy: E = pc  – Momenta are measured in GeV/c
E2tot = p2c2 + m2c4        → mass can usually be neglected (in all our calculations → thus: E = pc)
