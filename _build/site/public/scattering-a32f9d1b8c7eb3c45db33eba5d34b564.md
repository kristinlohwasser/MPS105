...
r &= \frac{2 \times 79 \times (1.602 \times 10^{-19})^2 C^2 }{5.30 \times 1.602 \times 10^{-19} x 10^6 J} \times 9\times 10^9 \frac{N m^2}{C^2} = 4.3 \times 10^{-14} m = 43 fm
\end{align*}
$$
...
$$
\begin{align*}
m c^2 &= 1.67 \times 10^{-27} kg \times \right( 3 \times 10^8 m/s)^2 = 1.5 \times 10^{-9} J \\
1.5 \times 10^{-9} J &= 1.5 \times 10^{-9} / 1.6 \times 10^{-19} eV = 939 MeV
\end{align*}
$$
