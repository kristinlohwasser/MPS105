...
1) express the fraction of the flux passing through band/annular b and deflected
by an angle θ

2) compare this to the general
differential cross section

3) connect it to the expression of the impact parameter derived using angular momentum and the potential (→ Pieter Kok / mechanics)
