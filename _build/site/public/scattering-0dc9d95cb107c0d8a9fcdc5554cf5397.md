...
\begin{align}
\frac{1}{2} m_\alpha {v^2_\alpha} &= \frac{1}{2} m'_\alpha {v'^2_\alpha} + \frac{1}{2} m'_t {v'^2_t}  \biggr\rvert \div\frac{1}{2} \\
m_\alpha {v^2_\alpha} &=  m'_\alpha {v'^2_\alpha} +  m'_t {v'^2_t} \; \biggr\rvert \; \textrm{multiply by m_\alpha} \\
