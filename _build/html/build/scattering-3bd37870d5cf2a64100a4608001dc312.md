...
\begin{align*}
\cancel{n_G A \Delta x} b \frac{\textrm{d}b}{\textrm{d} \theta} \textrm{d} \theta \textrm{d} \phi & = \cancel{n_G A \Delta x} \frac{\mathrm{d}\sigma}{\mathrm{d}\Omega} \Delta \Omega  &\biggr\rvert \; using \Delta \Omega = \sin \theta \mathrm{d}\theta \mathrm{d}\phi 
