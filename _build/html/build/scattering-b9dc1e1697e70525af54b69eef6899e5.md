...
Nuclear and Particle physics requires going to even smaller scales:


is not practical with light → Use particles instead (particle-wave duality → De Broglie wavelength)
Blablal
...
he Geiger-Marsden experiment, also known as the gold foil experiment, was a 1909 study led by Ernest Rutherford and conducted by Hans Geiger and Ernest Marsden. It involved firing a beam of positively charged alpha particles at a thin sheet of gold foil. The results, which showed that most alpha particles passed straight through but some were deflected at large angles and even bounced back, disproved the plum pudding model of the atom and led to the conclusion that atoms have a tiny, dense, positively charged nucleus

The experiments were performed between 1906 and 1913 by Hans Geiger and Ernest Marsden under the direction of Ernest Rutherford at the Physical Laboratories of the University of Manchester.
...
From his results for a head on collision, Rutherford knows that alpha particle scattering occurs close to the centre of an atom, at a radius 10,000 times smaller than the atom. The electrons have negligible effect. He begins by assuming no energy loss in the collision, that is he ignores the recoil of the target atom. He will revisit each of these issues later in his paper.[1]: 672  Under these conditions, the alpha particle and atom interact through a central force, a physical problem studied first by Isaac Newton.[45] A central force only acts along a line between the particles and when the force varies with the inverse square, like Coulomb force in this case, a detailed theory was developed under the name of the Kepler problem.[46]: 76  The well-known solutions to the Kepler problem are called orbits and unbound orbits are hyperbolas. Thus Rutherford proposed that the alpha particle will take a hyperbolic trajectory in the repulsive force near the centre of the atom as shown in Figure 2.
