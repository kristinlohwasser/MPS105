...
\begin{align*}
m^2_\alpha {v'^2_\alpha} +  m_\alpha m_t {v'^2_t} &= m^2_\alpha {v'^2_\alpha} + m^2_t {v'^2_t} + 2 m_\alpha m_t \vec{v'_\alpha}\cdot \vec{v'_t} \\
\cancel{m^2_\alpha {v'^2_\alpha}} +  m_\alpha m_t {v'^2_t} &= \cancel{m^2_\alpha {v'^2_\alpha}} + m^2_t {v'^2_t} + 2 m_\alpha m_t \vec{v'_\alpha}\cdot \vec{v'_t} &\biggr\rvert \; - m^2_t {v'^2_t}, \div 2 m_\alpha m_t  \\
{v'^2_t} \left(1 - \frac{m_t}{m_\alpha}\right) &= \vec{v'_\alpha}\cdot \vec{v'_t}
\end{align*}
