...
If we place a detectror with an area $A_D = R^2 $  The detec-
tor with area AD = R2 dΩ = R2 sin ϑ dϑ dφ in a distance R
from the scattering center B, receives the fraction
