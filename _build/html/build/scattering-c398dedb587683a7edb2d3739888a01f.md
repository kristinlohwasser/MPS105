...
&\biggr\rvert \; \textrm{using} \Delta \Omega = \sin \theta \mathrm{d}\theta \mathrm{d}\phi \\
&= n_G A \Delta x \frac{\textrm{d}b}{\textrm{d} \theta} \textrm{d} \theta \textrm{d} \phi 



Therefore measuring the relative fraction $\frac{\Delta J}{J}$ yields the differential cross section and with it the interaction potential as we have seen that the angle $\theta$ is defined as (see eq. (72) of the mechanics lecture notes):
