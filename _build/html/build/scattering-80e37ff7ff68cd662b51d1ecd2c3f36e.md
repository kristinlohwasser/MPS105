...
The potential energy of the alpha particle with charge $q_\alpha$ at a distance $r$ from the gold atoms with charge $Q_{\textrm{AU}}$ is:

$$
U = \frac{q_\alpha Q_{\textrm{AU}}}{4 \pi \epsilon_0 r}
$$
