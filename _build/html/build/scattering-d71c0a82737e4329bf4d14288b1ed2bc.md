...
Energy conservation:   $\,\,\,\,\,\,\,\,\,\, \frac{1}{2} m_\alpha {v^2_\alpha} = \frac{1}{2} m'_\alpha {v'^2_\alpha} + \frac{1}{2} m'_t {v'^2_t}$ <br>
Momentum conservation: $\,\,\, m_\alpha \vec{v_\alpha} = m'_\alpha \vec{v'_\alpha} + m'_t \vec{v'_t}$ <br>

Energy conservation:<br>
\begin{align}
\frac{1}{2} m_\alpha {v^2_\alpha} &= \frac{1}{2} m_\alpha {v'^2_\alpha} + \frac{1}{2} m'_t {v'^2_t}  \biggr\rvert \div\frac{1}{2} \\
m_\alpha {v^2_\alpha} &=  m_\alpha {v'^2_\alpha} +  m'_t {v'^2_t} \; \biggr\rvert \; \textrm{multiply by} \\
\raisebox{.5pt}{\textcircled{\raisebox{-.9pt} {1}}}
m^2_\alpha {v^2_\alpha} &=  m^2_\alpha {v'^2_\alpha} +  m_\alpha m'_t {v'^2_t} \; \biggr\rvert \; \textrm{multiply by m_\alpha}
\end{align}


Momentum conservation:<br>
\begin{align}
m_\alpha \vec{v_\alpha} &= m'_\alpha \vec{v'_\alpha} + m'_t \vec{v'_t} \; \biggr\rvert \; \textrm{square both sides} \\
m_\alpha {v^2_\alpha} &= m'_\alpha {v'^2_\alpha} + m'_t {v'^2_t} \\
\end{align}
