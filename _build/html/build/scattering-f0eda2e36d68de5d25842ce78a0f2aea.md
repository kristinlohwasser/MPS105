...
particles pass a gold foil with nuclei:
We define the inclusive or
integral cross-section as the area
σ = πr2 around the nuclei through which the α
particles need to pass to be scattered by an 2r
detectable angle θ
This is a generalisable definition: The cross
section is used to quantify the size or the
strength of an interaction with a particle
